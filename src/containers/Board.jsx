...
class Board extends Component {
  ...
  heroLevelUp(hero) {
    ...
    if (this.props.appState.difficulty > 1) {
  ...
  startGame() {
    console.log('start');
    const { newMap, heroPosition, trumpPosition, doors, vSize } =
      fillGrid(generateMap(1), 1, this.props.appState.hero, this.props.appState.difficulty);
    console.log(vSize);
    this.props.actions.setViewportSize(vSize);
    this.updateDimensions(vSize);
    this.props.actions.start(newMap, heroPosition, trumpPosition, doors, vSize);
  }
